      ...
      <main className="main-content">
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
          <div className="page-header">
            ...
            <p className="page-subtitle">{patients.length} assigned patients</p>
          </div>
          ...
          <div style={{ display: 'flex', gap: 12, marginBottom: 20, flexWrap: 'wrap' }}>
            <div style={{ position: 'relative', flex: 1, maxWidth: 360 }}>
              ...
              <input className="input-field" style={{ paddingLeft: 40 }} placeholder="Search patients..." value={search} onChange={(e) => setSearch(e.target.value)} />
            </div>
            <select className="input-field" style={{ width: 180 }} value={riskFilter} onChange={(e) => setRiskFilter(e.target.value)}>
            ...
            <div className="glass-card" style={{ overflow: 'hidden' }}>
              <table className="data-table">
                ...
                <tbody>
                  ...
                  {patients.length === 0 && <tr><td colSpan={5} style={{ textAlign: 'center', padding: 40, color: 'var(--text-muted)' }}>No patients</td></tr>}
                </tbody>
              </table>
            </div>
